...
Version  : 1.4.1
Release  : 47
URL      : https://github.com/facebook/zstd/releases/download/v1.4.1/zstd-1.4.1.tar.gz
Source0  : https://github.com/facebook/zstd/releases/download/v1.4.1/zstd-1.4.1.tar.gz
...
%prep
%setup -q -n zstd-1.4.1
%patch1 -p1
pushd ..
cp -a zstd-1.4.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1563571853
...
/usr/lib64/haswell/libzstd.so.1.4.1
/usr/lib64/libzstd.so.1
/usr/lib64/libzstd.so.1.4.1
