...
Version  : 1.3.6
Release  : 35
URL      : https://github.com/facebook/zstd/archive/v1.3.6.tar.gz
Source0  : https://github.com/facebook/zstd/archive/v1.3.6.tar.gz
...
%prep
%setup -q -n zstd-1.3.6
%patch1 -p1
pushd ..
cp -a zstd-1.3.6 buildavx2
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1538841261
export AR=gcc-ar
...
ln -s libzstd.so.1.3.6   %{buildroot}/usr/lib64/libzstd.so
ln -s libzstd.so.1.3.6   %{buildroot}/usr/lib64/libzstd.so.1
...
ln -s libzstd.so.1.3.6   %{buildroot}/usr/lib64/haswell/libzstd.so.1
popd
## install_append end
...
/usr/lib64/haswell/libzstd.so.1.3.6
/usr/lib64/libzstd.so.1
/usr/lib64/libzstd.so.1.3.6
